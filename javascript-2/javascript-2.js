...
foods.forEach(function(element,index,array){
    let totalCalories = element.carbs * 4 + element.protein * 4 + element.fat * 9;
    foods.calories = totalCalories;
}
//////////////////////////////////PROBLEMS 2-4//////////////////////////////////
/*
...
//CODE HERE
let blueProducts = saleProducts.filter()
////////////////////PROBLEM 4////////////////////
/*
...
//CODE HERE
let commenterId = userInfo.comments[0].responses[0].userId
////////////////////PROBLEM 12////////////////////
/*
...
let person = {
  name = 'Nathen',
  age = 26,
  jobs = ['Walmart', 'Gowireless', 'Verizon'],
  birthday = function plus1(){this.age + 1;},
  favorites: {
    color = 'Blue',
    number = 7,
    book = 'The Hobbit',
